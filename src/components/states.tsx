  ...
  return (
    <div className="space-y-3">
      {Array.from({ length: count }).map((_, index) => (
        <div key={index} className="panel min-h-[148px] rounded-[22px] p-4">
...
export function EmptyState({
  ...
  return (
    <div className="panel min-h-[220px] rounded-[28px] px-6 py-10 text-center">
    ...
    <div className="panel min-h-[220px] rounded-[28px] px-6 py-10 text-center">
      ...
      {onRetry ? (
        <button
          type="button"
          onClick={onRetry}
          className="pressable glass-strong mt-6 rounded-full px-5 py-2 text-[13px] text-ivory"
        >
          Try again
        </button>
      ) : null}
