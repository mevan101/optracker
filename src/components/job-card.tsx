...
import { companyInitials } from "@/lib/domain/text";
...
export function JobCard({ listing }: { listing: JobListing }) {
  return (
    <Link
      ...
      className="glass block rounded-[22px] p-4 transition hover:bg-white/[0.05]"
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-3">
            <h3 className="text-[16px] font-semibold leading-5 text-ivory">
              {listing.title}
            </h3>
          ...
          <p className="mt-3 line-clamp-2 text-[13px] leading-5 text-ash">
